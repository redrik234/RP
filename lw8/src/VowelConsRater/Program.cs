...
namespace VowelConsRater
{
    class Program
    {
        ...
        private static void SendRankToQueue(string contextId, float rank, string exchangeName, IModel model)
        {
        ...
        private static void RabbitListener()
        {
            ...
            consumer.Received += (model, ea) =>
            {
                ...
                if (argArr.Length == 4 && argArr[0] == "VCCmessage")
                {
                    ...
                    SendRankToQueue(data.id, result, outputExcangeName, channel);
